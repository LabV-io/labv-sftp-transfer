...
public class Config {
    ...
    /**
     * Global/default interval in seconds.
     * Allowed values:
     *  -1 => run-once mode (all folders run once, then exit)
     *  >= 1 => periodic mode
     */
    ...
    public static class FolderConfig {
        ...
        private String postAction;   // "move", "delete"
        private String archiveDir;   // used when postAction == "move"
        
        /**
         * Optional per-folder interval in seconds.
         * Must be >= 1 if set. Never -1 here.
         * If null, the global intervalSeconds applies (unless global is -1).
         */
